  ...
  return (
    <>
      ...
      <div className="py-2 mx-auto max-w-7xl sm:px-6 xl:px-0">
        <ul role="list" className="my-4 grid align-center grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <p className="flex max-w-2xl mb-1 text-sm text-gray-400 space-x-2">
                        ...
                        {ticket.need_tag_id.map((tag) =>
                          tag && tag.need_tag_id && tag.need_tag_id.id ? (
                            <span key={tag.need_tag_id} className="flex-shrink-0 inline-block px-2 py-0.5 text-orange-800 text-xs font-medium bg-orange-100 rounded-full">
                  ...
                  <div>
                    <div className="flex -mt-px divide-x divide-gray-200">
                      <div className="flex flex-1 w-0">
                        <a href={ticketUrl} className="relative inline-flex items-center justify-center flex-1 w-0 py-3 -mr-px text-sm font-medium text-gray-700 border border-transparent rounded-bl-lg hover:text-gray-500">
                      ...
                      <div className="flex flex-1 w-0 -ml-px">
                        <a href={`tel:${ticket.phone}`} className="relative inline-flex items-center justify-center flex-1 w-0 py-3 text-sm font-medium text-gray-700 border border-transparent rounded-br-lg hover:text-gray-500">
