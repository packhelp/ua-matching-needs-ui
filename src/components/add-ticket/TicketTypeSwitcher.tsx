  ...
  return (
    <div className="flex justify-between cursor-pointer">
      <div
        ...
        className={`${isNeed ? 'border border-transparent bg-blue-500 shadow-sm hover:bg-blue-600 text-white' : 'border border-blue-500 text-black'} w-full relative inline-flex justify-center items-center ml-auto px-2 py-2 text-xs font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
      >
      ...
      <div
        ...
        className={`${isOffer ? 'border border-transparent bg-amber-300 shadow-sm hover:bg-amber-400 text-black' : 'border border-amber-300 text-black'} w-full relative inline-flex justify-center items-center ml-auto px-2 py-2 text-xs font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
      >
